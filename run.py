...
if __name__ == "__main__":
    ...
    out = {
        ...
        "initial_period_days": result.period_history_days[0] if result.period_history_days else None,
        "final_period_days": result.period_history_days[-1] if result.period_history_days else None,
    }
